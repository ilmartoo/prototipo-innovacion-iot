    ...
    return (
      <>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          />
          <StatCard 
            value={playerRanking.points} 
            label="GOLES" 
          />
          <StatCard 
            value={`${playerData.distanciaTiro.media}m`} 
              ...
              <Card className="cursor-pointer">
                <CardContent className="flex items-center justify-between p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Analiza los lanzamientos desde posiciones</p>
                  </div>
                  {isLanzamientosOpen ? (
